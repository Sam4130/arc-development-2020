...
export default function LandingPage(props) {
    ...
    return(
        <Grid container direction={"column"} className={classes.mainContainer}>
            ...
            <Grid item>
                {/*----Revolution Block----*/}
                <Grid container style={{height: "100em"}}
                      alignItems={"center"}
                      justify={"center"}>
                    ...
                    >
                        ...
                        <Grid item sm style={{marginRight: matchesXS ? 0 : matchesSM ? "2em" : "5em",
                            ...
                            <Grid container direction={"column"}>
                                ...
                                <Typography variant={"subtitle2"}>Click below to Get in Touch!
                                    <span role={"img"} aria-label={"sweet hand man"}>🤙</span>
                                </Typography>
                                <Grid item>
