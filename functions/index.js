...
//three primary const and initialisations to use
const config = functions.config();
//allows cross side sharing to be authorised
...
const transporter = nodemailer.createTransport({
    service:"Gmail",
    auth:{user: config.user.email, pas: config.user.password}
});
...
exports.sendMail = functions.https.onRequest((request, response) => {
    cors(request, response, () => {
        ...
        mailOptions = {...mailOptions,
            to: "testemailmaterial.ui@gmail.com",
